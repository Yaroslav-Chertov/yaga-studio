...
const reasons = [
  ...
  },
  {
    ...
    text: "Используем современные инструменты, включая AI, там, где они действительно помогают ускорить процесс. При этом ключевые решения по структуре, визуальному языку и качеству проработки всегда остаются под ручным контролем.",
  },
];
