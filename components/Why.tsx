...
const reasons = [
  {
    title: "Продуктовая экспертиза",
    text: "Смотрим на проект не только через призму дизайна и разработки, но и через задачи бизнеса. Понимаем контекст продукта, цели аудитории и ключевые сценарии, чтобы принимать решения, которые помогают продукту быть удобным, эффективным и успешным.",
  },
  {
    title: "Смелая визуальная подача",
  ...
  {
    title: "Работаем с людьми",
    text: "За каждым проектом стоят живые люди, поэтому для нас важен не только результат, но и то, как мы к нему приходим. Ищем общий язык, погружаемся в контекст и стараемся быть настоящими партнёрами, а иногда и друзьями.",
  },
];
    ...
    <section id="why" className="why">
      ...
      <div ref={bannerRef} className="why__banner">
        ...
        <p className="why__banner-text">
          Если вам близок современный и&nbsp; смелый подход к&nbsp;дизайну
          и&nbsp;разработке,{" "}
